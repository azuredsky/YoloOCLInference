...
If you want to let the engine free-flow without any display or saving options, the benchmarks reported here will be noticed. 
Command: eg:  *YoloOCLInference.exe -input pedestrians.jpg -display 0 -save 0 *
